...
void TopLevelSession::CreateMessage(IObserver::EventTypes eventType)
{
    Notify(eventType);

}

void TopLevelSession::CreateMessage(IObserver::EventTypes eventType, void* data)
{
...
void TopLevelSession::CreateMessage(std::string message) {
